...
$(document).ready(function () {
    tablaData = $('#tbdata').DataTable({
        ...
        "columns": [
            { "data": "idMoneda", "visible": false, "searchable": false },
            { "data": "descripcion" },
            { "data": "simbolo" },
            { "data": "idSunat" },
            {
...
$("#btnGuardar").click(function () {
    ...
    modelo["idMoneda"] = parseInt($("#txtId").val());
        ...
        fetch("/Moneda/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo", "Moneda fue creada", "success");
                } else {
        ...
        fetch("/Moneda/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide");
                    swal("Listo", "Moneda fue modificada", "success");
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error");
                }
            })
...
$('#tbdata tbody').on("click", ".btn-eliminar", function () {
    ...
    swal(
        {
            title: "¿Está seguro?",
            text: `Eliminar Moneda "${data.descripcion}"`,
            type: "warning",
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                fetch(`/Moneda/Eliminar?idMoneda=${data.idMoneda}`, {
                    method: "DELETE"
                })
                    .then(response => {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            swal("Listo", "Moneda fue eliminada", "success");
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error");
                        }
                    })
