        ...
        fetch("/Empresa/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo", "El Empresa fue creado", "success");
                } else {
        ...
        fetch("/Empresa/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide");
                    swal("Listo", "El Empresa fue modificado", "success");
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error");
                }
            })
...
$('#tbdata tbody').on("click", ".btn-eliminar", function () {
    ...
    swal(
        {
            title: "¿Está seguro?",
            text: `Eliminar al Empresa "${data.nombre}"`,
            type: "warning",
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                fetch(`/Empresa/Eliminar?idUsuario=${data.idUsuario}`, {
                    method: "DELETE"
                })
                    .then(response => {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            swal("Listo", "El Empresa fue eliminado", "success");
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error");
                        }
                    })
